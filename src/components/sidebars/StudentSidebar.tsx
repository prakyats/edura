...
export function StudentSidebar({ user, currentPage, onNavigate, onLogout, isOpen, onToggle }: StudentSidebarProps) {
  const navigationItems = [
    {
      id: 'home' as StudentPage,
      label: 'Home',
      icon: Home
    },
    {
      id: 'timetable' as StudentPage,
      label: 'My Timetable',
      icon: Calendar
    },
    {
